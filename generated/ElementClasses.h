...
class Element_NPLM: public Element
{
public:
	Element_NPLM();
	virtual ~Element_NPLM();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_STFL: public Element
{
public:
	Element_STFL();
	virtual ~Element_STFL();
	static int update(UPDATE_FUNC_ARGS);
};
...
class Element_BDST: public Element
{
public:
	Element_BDST();
	virtual ~Element_BDST();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_FRCT: public Element
{
public:
	Element_FRCT();
	virtual ~Element_FRCT();
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_REP: public Element
{
public:
	Element_REP();
	virtual ~Element_REP();
...
class Element_REPG: public Element
{
public:
	Element_REPG();
	virtual ~Element_REPG();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_HEAT: public Element
{
public:
	Element_HEAT();
