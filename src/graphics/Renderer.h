...
public:
	...
	int plottext(int x, int y, const char *s, int r, int g, int b, int a);
	int plottext(int x, int y, std::string s, int r, int g, int b, int a);

	int plotchar(int x, int y, int c, int r, int g, int b, int a);
