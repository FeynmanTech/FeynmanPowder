...
class LuaScriptInterface: public CommandInterface
{
	...
	static int simulation_plotchar(lua_State * l);
	static int simulation_rawplotchar(int x, int y, int c, int r, int g, int b, int a);
	static int simulation_plottext(lua_State * l);
	static int simulation_beep(lua_State * l);
