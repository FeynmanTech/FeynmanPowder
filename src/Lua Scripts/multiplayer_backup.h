...
"	mpList[p] = d\n"
"end\n"
"CurrentNick = mpList['default_nick'] or ''\n"
...
"    end,\n"
"    channel = function(self, msg, args) self:addline('Current channel: ' .. CurrentChannel, 50, 255, 50) end,\n"
"	 reply = function(self,msg,args)\n"
"        if args[1] then\n"
"            mpAdd('autoreply', table.concat(args, ' '))\n"
"			 self:addline('Set autoreply to: ' .. table.concat(args, ' '),50,255,50)\n"
"        end\n"
"    end,\n"
...
"                    text = text:gsub('/nick', '/n*ck')\n"
"                    self:addline('Using the phrase \"/nick\" gets you auto-kicked!',100,0,0)\n"
"                end\n"
"                conSend(19,text:gsub('/nick', '/n*ck'),true)\n"
...
"        if mpList['autoreply'] and mpList['autoreply'] ~= 'none' and not isAFK then\n"
"            conSend(19, (mpList['autoreply']):gsub('%(user%)', con.members[id].name), true)\n"
"            chatwindow:addline('Autoreply: ' .. (mpList['autoreply']):gsub('%(user%)', con.members[id].name),0,250,0)\n"
"        end\n"
"    end,\n"
"    [18] = function()\n"
"        local id = cByte()\n"
