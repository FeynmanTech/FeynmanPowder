...
"    sidebutton:process(mousex,mousey + 17*TPTMP_ICONSADDED - 2,button,event,wheel)\n"
...
"    gfx.drawRect(sidebutton.x, sidebutton.y-17*TPTMP_ICONSADDED+2, sidebutton.w+1, sidebutton.h+1,200,200,200)\n"
"    local color=WHITE\n"
"    if not MANAGER.hidden then\n"
"        step()\n"
"        gfx.fillRect(sidebutton.x, sidebutton.y-17*TPTMP_ICONSADDED+2, sidebutton.w+1, sidebutton.h+1)\n"
"        color=BLACK\n"
"    end\n"
"    for i,dline in ipairs(lua_letters[ICON]) do\n"
"        tpt.drawline(dline[1]+sidebutton.x,dline[2]+sidebutton.y-17*TPTMP_ICONSADDED+1,dline[3]+sidebutton.x,dline[4]+sidebutton.y-17*TPTMP_ICONSADDED+1,color[1],color[2],color[3])\n"
"    end\n"
