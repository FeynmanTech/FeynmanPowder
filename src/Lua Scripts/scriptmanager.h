...
"local EXE_NAME\n"
"if OS == \"Windows\" then\n"
"	EXE_NAME = jacobsmod and \"Jacob1's Mod.exe\" or \"FeynmanPowder.exe\"\n"
"elseif OS == \"Linux\" then\n"
"	EXE_NAME = jacobsmod and \"Jacob1's Mod\" or \"FeynmanPowder\"\n"
"elseif OS == \"OSX\" then\n"
...
"	sidebutton:process(mousex,mousey + ICONS_ADDED*16,button,event,wheel)\n"
...
"	gfx.drawRect(sidebutton.x, sidebutton.y+1 - ICONS_ADDED*16, sidebutton.w+1, sidebutton.h+1,200,200,200)\n"
"	local color=WHITE\n"
"	if not MANAGER.hidden then\n"
"		step()\n"
"		gfx.fillRect(sidebutton.x, sidebutton.y+1 - ICONS_ADDED*16, sidebutton.w+1, sidebutton.h+1)\n"
"		color=BLACK\n"
"	end\n"
"	for i,dline in ipairs(lua_letters[ICON]) do\n"
"		tpt.drawline(dline[1]+sidebutton.x,dline[2]+sidebutton.y - ICONS_ADDED*16,dline[3]+sidebutton.x,dline[4]+sidebutton.y - ICONS_ADDED*16,color[1],color[2],color[3])\n"
"	end\n"
